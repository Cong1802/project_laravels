                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                ...
                                <a href="{{ url('').'/Repassword/'.$data[0]->token }}" style="display:inline-block;text-decoration:none">
                                    ...
                                    <table style="width:auto;max-width:570px;margin:0 auto;padding:0" align="center" width="570" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;padding:35px"><span class="im">  
                                                ...
                                                <a href='{{ url('').'/Repassword/'.$data[0]->token }}' style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;display:block;display:inline-block;width:200px;min-height:20px;padding:10px;background-color:#3869d4;border-radius:3px;color:#ffffff;font-size:15px;line-height:25px;text-align:center;text-decoration:none;background-color:#3869d4">Đặt lại mật khẩu</a>
                                                </p>
