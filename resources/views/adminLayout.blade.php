            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-edit"></i> Nền tảng <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ URL::to('FormCategory')}}">Thêm danh mục</a></li>
                      <li><a href="{{ URL::to('Categories')}}">Danh mục</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Kênh truyền thông <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ URL::to('FormChannel')}}">Thêm kênh</a></li>
                      <li><a href="{{ URL::to('ListChannel')}}">Danh sách kênh</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
